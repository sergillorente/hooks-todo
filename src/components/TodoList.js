...
export default function TodoList() {
    ...
    return (
        <div className="container mx-auto max-w-md text-center font-mono">
            ...
            <ul className="list-reset text-green p-0">
                {state.todos.map(todo => (
                    ...
                    >
                        <span 
                            onDoubleClick={async () => {
                                const response = await axios.patch(`https://hooks-api-eosin.vercel.app/todos/${todo.id}`, {
                        ...
                        <button 
                            onClick={async () => {
                                await axios.delete(`https://hooks-api-eosin.vercel.app/todos/${todo.id}`)
